    ...
    <div className="space-y-8">
      ...
      <section className="bg-gray-800 rounded-xl border border-gray-600 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="p-4 border border-gray-600 rounded-lg opacity-60 text-white">
            <p className="font-medium">개념 추출</p>
            <p className="text-sm text-gray-400">API: /study/concepts</p>
          </div>
          <div className="p-4 border border-gray-600 rounded-lg opacity-60 text-white">
            <p className="font-medium">질문 생성</p>
            <p className="text-sm text-gray-400">API: /study/questions</p>
          </div>
          <div className="p-4 border border-gray-600 rounded-lg opacity-60 text-white">
            <p className="font-medium">학습 계획</p>
            <p className="text-sm text-gray-400">API: /study/plan</p>
          </div>
        </div>
      </section>
