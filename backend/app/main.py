...
from app.api.routes import dashboard, file_intelligence, knowledge, settings_api, study, system, upload
...
def create_app() -> FastAPI:
    ...
    # CORS: 로컬 데스크톱 앱(Tauri)은 origin이 null/tauri://localhost 등 다양하므로
    # 모든 origin 허용. 웹 배포 시에도 공개 API이므로 제한 불필요.
    app.add_middleware(
        CORSMiddleware,
        allow_origins=["*"],
